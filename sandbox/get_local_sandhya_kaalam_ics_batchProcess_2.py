    ...
    with open(f'{location.replace(", ", "_").replace(" ", "_")}_sandhya_kaalam_{start_date[:4]}.ics', 'w') as ics_file:
        ...
        if location_data:
            ...
            for day, sunrise_time, sunset_time in get_sunrise_sunset_batch(days, lat, lon):
                ...
                ics_file.write(f"SUMMARY:Sunrise and Sunset Event for {day}\n")
                ics_file.write("END:VEVENT\n")

        ics_file.write("END:VCALENDAR\n")

# Example usage
create_ics_file("Mason, OH", "2025-01-19", "2025-01-19")

# BEGIN
# VERSION:2.0 PRODID:-//Example Corp//NONSGML Calendar//EN BEGIN
# UID:1234567890 DTSTAMP:20220301T050000Z DTSTART:20220315T090000Z DTEND:20220315T100000Z SUMMARY
# with Clients DESCRIPTION
# upcoming projects and deadlines with clients. LOCATION
# Room END
# ENDprint(f'{event_start}')